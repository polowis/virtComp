# Generated by Django 3.1.3 on 2021-02-15 00:45

import app.core.db.model_mixin
import app.core.util.base
import app.managers.user.user_manager
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', app.managers.user.user_manager.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='AgentCustomer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', models.DecimalField(decimal_places=4, default=300, max_digits=20)),
            ...
            bases=(models.Model, app.core.db.model_mixin.ModelMixin),
        ),
        migrations.CreateModel(
            name='Continent',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_money', models.DecimalField(decimal_places=4, default=0, max_digits=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now, editable=False)),
                ('updated_at', models.DateTimeField()),
                ('company_store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.globalstore')),
                ('produced_item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='app.produceditem')),
            ],
        ),
        migrations.CreateModel(
