# Generated by Django 3.1.3 on 2020-12-28 04:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_qualification', models.IntegerField(default=models.IntegerField(default=app.models.core.agent.agent_stats.random_score))),
                ('current_productivity', models.IntegerField(default=models.IntegerField(default=app.models.core.agent.agent_stats.random_score))),
                ('current_communication', models.IntegerField(default=models.IntegerField(default=app.models.core.agent.agent_stats.random_score))),
                ('current_creativity', models.IntegerField(default=models.IntegerField(default=app.models.core.agent.agent_stats.random_score))),
                ('current_leadership', models.IntegerField(default=models.IntegerField(default=app.models.core.agent.agent_stats.random_score))),
                ('current_learning', models.IntegerField(default=models.IntegerField(default=app.models.core.agent.agent_stats.random_score))),
