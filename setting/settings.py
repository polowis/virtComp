"""
Django settings for virtComp project.
...
SECRET_KEY = 'gf5=zp#l5p)6allwe5bv7sl2%)y+50bssam3-$w7il=!9z^-9h'
...
MIDDLEWARE = [
    ...
    'app.core.middleware.company_logged_in.CompanyLoggedInMiddleware',
]
